  ...
  public void testLangDataBinder() {
    withApplication(
        (app) -> {
          ...
          String amount = copyFormWithoutRawData(myForm, app).field("amount").getValue().get();
          assertThat(amount)
              .isEqualTo(
                  amount.contains(" ")
                      ? "1 234 567,89"
          ...
          assertThat(copyFormWithoutRawData(myForm, app).field("amount").getValue().get())
          ...
          amount = copyFormWithoutRawData(myForm, app).field("amount").getValue().get();
          assertThat(amount)
              .isEqualTo(
                  amount.contains(" ")
                      ? "1 234 567"
  ...
  public void testLangAnnotationDateDataBinder() {
    withApplication(
        (app) -> {
          ...
          assertThat(copyFormWithoutRawData(myForm, app).field("date").getValue().get())
  ...
  public void testLangDateDataBinder() {
    withApplication(
        (app) -> {
          ...
          assertThat(myForm.hasGlobalErrors()).isFalse();
          Birthday birthday = myForm.get();
          assertThat(copyFormWithoutRawData(myForm, app).field("alternativeDate").getValue().get())
  ...
  public void testInvalidMessages() {
    withApplication(
        (app) -> {
          ...
          assertThat(myForm.getError("dueDate").get().messages().get(1))
              .isEqualTo("error.invalid.java.util.Date");
          assertThat(myForm.getError("dueDate").get().message())
              .isEqualTo("error.invalid.java.util.Date");
          ...
          assertThat(myForm.getError("dueDate").get().messages().get(1))
              .isEqualTo("error.invalid.java.util.Date");
          assertThat(myForm.getError("dueDate").get().messages().get(2))
  ...
  public void testConstraintWithInjectedMessagesApi() {
    withApplication(
        (app) -> {
          ...
          assertThat(myForm.getError("anotherZip").get().message())
