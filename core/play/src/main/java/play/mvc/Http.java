...
public class Http {
  ...
  public static class Context {
    ...
    public Messages messages() {
      Request request =
          lang != null ? request().addAttr(Messages.Attrs.CurrentLang, lang) : request();
    ...
    public void setTransientLang(Lang lang) {
      ...
      if (langs.availables().contains(lang)) {
        ...
        throw new IllegalArgumentException(
            "Language not supported in this application: "
                + lang
                + " not in "
                + langs.availables());
      }
  ...
  public static class RequestBuilder {
    ...
    public RequestBuilder tags(Map<String, String> tags) {
      attr(
          new TypedKey(RequestAttrKey.Tags()),
          JavaHelpers$.MODULE$.javaMapToImmutableScalaMap(tags));
      return this;
    }
  ...
  public static class Response implements HeaderNames {
    ...
    public void discardCookie(String name, String path, String domain, boolean secure) {
      cookies.add(
          new Cookie(
              name, "", play.api.mvc.Cookie.DiscardedMaxAge(), path, domain, secure, false, null));
    }
